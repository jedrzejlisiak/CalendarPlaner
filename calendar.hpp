...
public:
    ...
    void hide(int year, int xmonth, int xday);
...
private:
    ...
    int x, y, num, row, col;
    char ready[50], end[100], smonth[50], syear[50], sday[50], temp[50],detail[50];
    string key, saved, parametr, parametr2, name, date, is_saved;
};
